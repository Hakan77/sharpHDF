...
namespace SharpHDF.Library.Tests.Objects
{
    ...
    public class Hdf5DatasetTests : BaseTest
    {
        ...
        {
            var filename = GetFilename("createdatasetinfile.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.Int8, properties);
        ...
        {
            var filename = GetFilename("opendatasetinfile.h5");
        ...
        {
            var filename = GetFilename("createdatasetingroup.h5");
            ...
            var dataset = group.Datasets.Add("dataset1", Hdf5DataTypes.Int8, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("opendatasetingroup.h5");
        ...
        {
            var filename = GetFilename("setdatatnull.h5");
        ...
        {
            var filename = GetFilename("setdatamismatch.h5");

            var file = Hdf5File.Create(filename);

            var properties = new List<Hdf5DimensionProperty>();
            var property = new Hdf5DimensionProperty { CurrentSize = 3 };
            properties.Add(property);
        ...
        {
            var filename = GetFilename("setarraysizemismatch.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.Int32, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("set2darraysizemismatch1.h5");

            var file = Hdf5File.Create(filename);

            var properties = new List<Hdf5DimensionProperty>();
            var property1 = new Hdf5DimensionProperty { CurrentSize = 3 };
            properties.Add(property1);
            var property2 = new Hdf5DimensionProperty { CurrentSize = 2 };
        ...
        {
            var filename = GetFilename("set2darraysizemismatch2.h5");
            ...
            var property1 = new Hdf5DimensionProperty { CurrentSize = 3 };
            properties.Add(property1);
            var property2 = new Hdf5DimensionProperty { CurrentSize = 5 };
            properties.Add(property2);
        ...
        {
            var filename = GetFilename("setarraydimensionmismatch1.h5");

            var file = Hdf5File.Create(filename);

            var properties = new List<Hdf5DimensionProperty>();
            var property = new Hdf5DimensionProperty { CurrentSize = 5 };
            properties.Add(property);
        ...
        {
            var filename = GetFilename("setarraydimensionmismatch2.h5");

            var file = Hdf5File.Create(filename);

            var properties = new List<Hdf5DimensionProperty>();
            var property1 = new Hdf5DimensionProperty { CurrentSize = 5 };
            properties.Add(property1);
            var property2 = new Hdf5DimensionProperty { CurrentSize = 2 };
            properties.Add(property2);
        ...
        public void SetInt8()
        {
            var filename = GetFilename("setint8.h5");
        ...
        {
            var filename = GetFilename("setint16.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.Int16, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("setint32.h5");
        ...
        {
            var filename = GetFilename("setint64.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.Int64, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("setuint8.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.UInt8, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("setuint16.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.UInt16, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("setuint32.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.UInt32, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("setuint64.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.UInt64, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("setsingle.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.Single, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("setdouble.h5");
            ...
            var dataset = file.Datasets.Add("dataset1", Hdf5DataTypes.Double, properties);
            Assert.IsNotNull(dataset);
        ...
        {
            var filename = GetFilename("set2dint8.h5");

            var file = Hdf5File.Create(filename);

            var properties = new List<Hdf5DimensionProperty>();
            var property1 = new Hdf5DimensionProperty { CurrentSize = 2 };
            properties.Add(property1);
            var property2 = new Hdf5DimensionProperty { CurrentSize = 3 };
            properties.Add(property2);
        ...
        {
            var filename = GetFilename("set2dint16.h5");
        ...
        {
            var filename = GetFilename("set2dint32.h5");
        ...
        {
            var filename = GetFilename("set2dint64.h5");
        ...
        {
            var filename = GetFilename("set2duint8.h5");
        ...
        {
            var filename = GetFilename("set2duint16.h5");
        ...
        {
            var filename = GetFilename("set2duint32.h5");
        ...
        {
            var filename = GetFilename("set2duint64.h5");
        ...
        {
            var filename = GetFilename("set2dsingle.h5");
        ...
        {
            var filename = GetFilename("set2ddouble.h5");
