...
namespace SharpHDF.Library.Tests.Objects
{
    ...
    public class Hdf5AttributeTests : BaseTest
    {
        ...
        {
            var fileName = GetFilename("createattributeonfile.h5");
        ...
        {
            var fileName = GetFilename("createattributetwiceonfile.h5");
        ...
        {
            var fileName = GetFilename("createattributetwiceongroup.h5");

            var file = Hdf5File.Create(fileName);
            var group = file.Groups.Add("test");
        ...
        {
            var fileName = GetFilename("createattributetwiceondataset.h5");

            var file = Hdf5File.Create(fileName);
            var group = file.Groups.Add("test");
            var dimensionProps = new List<Hdf5DimensionProperty>();
            var prop = new Hdf5DimensionProperty { CurrentSize = 1 };
            dimensionProps.Add(prop);

            var dataset = group.Datasets.Add("dataset1", Hdf5DataTypes.Int32, dimensionProps);
        ...
        {
            var fileName = GetFilename("updateattributewithmistmachonfile.h5");

            var file = Hdf5File.Create(fileName);
            var attribute = file.Attributes.Add("attribute1", "test");
        ...
        {
            var fileName = GetFilename("updateattributewithmistmachongroup.h5");

            var file = Hdf5File.Create(fileName);
            var group = file.Groups.Add("group");
            var attribute = group.Attributes.Add("attribute1", "test");
        ...
        {
            var fileName = GetFilename("updateattributewithmistmachondataset.h5");
            ...
            var attribute = dataset.Attributes.Add("attribute1", "test");
        ...
        {
            var fileName = GetFilename("updatestringattributeonfile.h5");
        ...
        {
            var fileName = GetFilename("updatestringattributeongroup.h5");
        ...
        {
            var fileName = GetFilename("updatestringattributeondataset.h5");
        ...
        {
            var fileName = GetFilename("getattributeonfile.h5");
        ...
        {
            var fileName = GetFilename("createattributeongroup.h5");
        ...
        {
            var fileName = GetFilename("getattributeongroup.h5");
        ...
        {
            var fileName = GetFilename("createattributeondataset.h5");
        ...
        {
            var fileName = GetFilename("getattributeondataset.h5");
        ...
        {
            var fileName = GetFilename("deleteattributeonfile.h5");
        ...
        {
            var fileName = GetFilename("deleteattributeongroup.h5");
        ...
        {
            var fileName = GetFilename("deleteattributeondataset.h5");
        ...
        {
            var fileName = GetFilename("allattributetypesonfile.h5");
        ...
        {
            var fileName = GetFilename("updateallattributetypesonfile.h5");
